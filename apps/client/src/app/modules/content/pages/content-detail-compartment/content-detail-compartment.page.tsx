...
import styles from './content-detail-compartment.module.scss';
			...
			<form onSubmit={handleSubmit(onSubmit)} style={{ height: '100%' }}>
				<div className={cxBind('p-content-detail')}>
					<div className={cxBind('p-content-detail__fields')}>
						<RenderFields siteId={siteId!} fieldPrefix="fields." fields={contentType?.fields.filter((field) => field.compartmentId === compartmentId) || []} />
					</div>
