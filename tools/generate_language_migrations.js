...
languages.forEach((partialLang) => {
	...
	fs.appendFileSync(path.join(__dirname, 'output', folderName, 'down.sql'), `DELETE FROM content_components WHERE id = '${language.id}';\n`);
})
